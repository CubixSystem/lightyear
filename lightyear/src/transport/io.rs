...
impl IoDiagnosticsPlugin {
    ...
    pub const BYTES_IN: DiagnosticPath = DiagnosticPath::const_new("lightyear/bytes_in");
    /// How many bytes do we send per second
    pub const BYTES_OUT: DiagnosticPath =
        DiagnosticPath::const_new("lightyear/bytes_out");

    /// How many bytes do we receive per second
    pub const PACKETS_IN: DiagnosticPath =
        DiagnosticPath::const_new("lightyear/packets_in");
    /// How many bytes do we send per second
    pub const PACKETS_OUT: DiagnosticPath =
        DiagnosticPath::const_new("lightyear/packets_out");
